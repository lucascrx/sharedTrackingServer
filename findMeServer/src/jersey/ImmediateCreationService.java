...
public class ImmediateCreationService {
	...
	private final String logTag = "Jersey.ImmediateCreation : ";
	  ...
	  public CreationResponse createSession(
		  ...
		  String header = Constants.formatHeader(logTag+"New Service for Creating Immediate Session ");
		  ...
		  System.out.println(logTag+"starting timestamp : "+response.getStartTime().getTime());
