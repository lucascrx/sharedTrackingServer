...
public class PreparedCreationService {
	...
	private final String logTag = "Jersey.PreparedCreation : ";
	  ...
	  public CreationResponse createSession(
		      ...
		      @FormParam(Constants.POST_PARAM_LABEL_STARTING_TIME) Timestamp start,
		      @FormParam(Constants.POST_PARAM_LABEL_ENDING_TIME) Timestamp end,
		      @Context HttpServletResponse servletResponse) throws IOException {
		  
		  System.out.println(logTag+"New Service for Creating Prepared Session ");
