...
public class Constants {
	...
	public static final String dbURL = "jdbc:mysql://localhost:3307/guidance";
	...
	public static final String[] mainTableFieldTypes = 
		{"INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY","VARCHAR(50) NOT NULL UNIQUE","VARCHAR(50) NOT NULL UNIQUE","VARCHAR(255) NOT NULL","TIMESTAMP NOT NULL","CHAR(64)","INT NOT NULL","TIMESTAMP NULL DEFAULT NULL","TIMESTAMP NOT NULL"};
	...
	public static final String[] sessionTableFieldTypes =
		{"INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY","DOUBLE NOT NULL","DOUBLE NOT NULL","TIMESTAMP NOT NULL","VARCHAR(50) NOT NULL","VARCHAR(255) NOT NULL"};
